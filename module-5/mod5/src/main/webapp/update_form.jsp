...
<html>
<head>
  <title>Update Movie: <%= movie.getTitle() %></title>
  <style>
...
<div class="container">
  ...
  <form action="update_processor.jsp" method="POST">
    ...
    <div class="form-group">
      <label>Movie ID (Non-editable):</label>
      <div class="readonly"><%= movie.getMovieId() %></div>
    </div>
    ...
    <a href="update_selection.jsp" class="back-link">Select Different Movie</a>
  </form>
</div>
</body>
</html>
